...
// Cityestate custom icon
function cityestate_icomoon_composer( $settings, $value ){
   
   // Set hidden element for icon
   $output = '<input id="cityestate_icomoon_textbox" name="'.$settings['param_name'].'" class="wpb_vc_param_value  '
   .$settings['param_name'].' '.$settings['type'].'_field" type="hidden" value="'
             .$value.'">';
	
	// Call jquery for icon			 	
	$output .= "<script>jQuery(document).ready(function() { jQuery('input[name=\"iconfonts_name\"]').click(function(){ jQuery('#cityestate_icomoon_textbox').val(jQuery(this).val()) ; });  } );</script>";
   	// List all the custom icon
   	$output .= '<div id="retinaicon-form" class="cityestate-iconfonts-wrapper">
		
	<div class="cityestate-icons-list-wrapper">
		<ul class="cityestate-icons-list">
	...
	</div><script type="text/javascript">jQuery(document).ready(function(){  var val = jQuery("#cityestate_icomoon_textbox").val();  jQuery("#"+val).trigger("click"); });</script>';
	
	return $output;
}

// Check visual comnposer is exit
if( class_exists( 'Vc_Manager' ) ):
	vc_add_shortcode_param( 'iconfonts', 'cityestate_icomoon_composer' );
endif;