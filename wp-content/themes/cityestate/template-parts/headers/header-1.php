...
// Get header detail
$header_logo 	= cityestate_option( 'header_logo', 'url' );
...
$yop_bar 		= cityestate_option( 'header_top_bar' );
...
// Check is sticky menu
$sticky_menu = "";
if( $is_sticky ){
	$sticky_menu = "sticky";
}

// Check header logo is available
...
<header>
	<div class="<?php echo esc_attr($sticky_menu); ?>">
		<div class="<?php echo esc_attr($layout_width); ?>">
			...
			<?php if( $yop_bar == 1 && !is_page_template( 'templates/template_splash.php' ) ){ get_template_part( 'template-parts/headers/top_bar' ); } ?>
						  	...
						  	<div class="container-fluid">
						    	<!-- Brand and toggle get grouped for better mobile display -->
						   		<div class="navbar-header">
						      		...
						      		<!-- Theme logo -->
						      		<div class="main-logo">
						      			<a class="navbar-brand logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php					
											if( !empty( $header_logo ) ) { ?>
